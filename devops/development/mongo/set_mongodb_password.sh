...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"admin1234"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"devel"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"develuser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"develpwd"}
