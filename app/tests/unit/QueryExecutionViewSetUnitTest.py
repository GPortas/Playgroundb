...
class QueryExecutionViewSetUnitTest(BaseViewSetUnitTest):
    ...
    def test_create_calledCorrectly_returnCorrectJSONResponse(self):
    ...
    def test_create_calledWithInnerServiceWhichRaisesServiceError_returnCorrectJSONResponse(self):
        json_raw = '{"query":"db.collection.find({})"}'
